...
\item The 3rd row illustrates the results from the phase-corrected parameters. These show good agreement with the reference case, apart from slightly exagerated off-diagonal lobes for the 
\end{itemize}
