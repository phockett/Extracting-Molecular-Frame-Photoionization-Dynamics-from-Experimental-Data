...
\item The bottom row shows normalised difference plots between the reference and phase-corrected results. This highlights the differences in th $|3,\pm1\rangle$ components.
\end{itemize}
