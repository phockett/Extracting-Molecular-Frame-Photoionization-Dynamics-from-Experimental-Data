...
\begin{itemize}
\item The reference matrix elements produce the MFPADs shown in the top row of the figure, which provide a reference for the fidelity of the reconstructed MFPADs. Polarization geometries are illustrated for $z,x,y,d$ cases, where $z$ is parallel to the bond axis, $x,y$ perpendicular and $d$ diagonal ()
