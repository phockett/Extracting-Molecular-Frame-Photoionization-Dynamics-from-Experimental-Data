...
\item The bottom row shows normalised difference plots between the reference and phase-corrected results. This emphasies the differences in the $|3,\pm1\rangle$ components.
\end{itemize}
