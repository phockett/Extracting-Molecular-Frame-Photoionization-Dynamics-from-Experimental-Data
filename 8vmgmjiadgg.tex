...
\item The bottom row shows normalised difference plots between the reference and phase-corrected results. This highlights the differences in teh $|3,\pm1\rangle$ components.
\end{itemize}
