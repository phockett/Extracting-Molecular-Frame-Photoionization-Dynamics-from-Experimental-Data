...
\item The 3rd row illustrates the results from the phase-corrected parameters. These show good agreement with the reference case, apart from slightly exa
\end{itemize}
