...
\begin{itemize}
\item The final results are generally quite close to the inputs. In this case, the ~10% random noise added, and the 1st phase was fixed as a reference during fitting; all other parameters were free.)
