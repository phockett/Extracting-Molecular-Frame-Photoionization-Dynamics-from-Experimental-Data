...
\item The phase results broadly fall into two classes, (a) cases which show good agreement within a $chi^2$ cluster, and (b) cases which have two values per $chi^2$ cluster. Additionally there i
\end{enumerate}
