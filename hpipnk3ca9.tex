...
\item An alternative uncertainty estimation can be obtained from the individual parameter set results, based on the curvature of the $\chi^2$ hyperspace w.r.t. each parameter, or w.r.t. all other paramters. However, in testing this value was found to be undefined in many cases here, likely due to the correlated nature of the fit. Hence statistical sampling seems a better approach here.
\end{itemize}
