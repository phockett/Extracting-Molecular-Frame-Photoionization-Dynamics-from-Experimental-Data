...
\item There are multiple bands of fits which converged to higher $\chi^2$; these are indicative of multiple local minima and/or simply arise from fits which did not conv
