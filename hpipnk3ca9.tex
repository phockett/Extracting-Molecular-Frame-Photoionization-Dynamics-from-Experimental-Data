...
\begin{enumerate}
\item The results appear to indicate a single global minima, with $\chi^2 < 2.3\times10^{-3}$. In the test case, 349 fits obtained this region of the fitting space, although there is some spr
