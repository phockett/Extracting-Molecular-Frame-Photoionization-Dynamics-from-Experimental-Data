...
To drill down into the results, the values and clustering of the retrieved parameter sets can be investigated, as well as the overall quality of the fit Fig. \ref{494229}, which illustrates the spread in retrieved parameters
