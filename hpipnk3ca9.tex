...
\begin{enumerate}
\item The results for the magnitudes show very little difference over the range investigated, indicating good agreement here in all results. (Close inspection reveals values typically within 10)
\end{enumerate}
