...
\item An alternative uncertainty estimation can be obtained from the individual parameter set results, based on the curvature of the $\chi^2$ hyperspace w.r.t. each parameter. In testing this value was 
\end{itemize}
