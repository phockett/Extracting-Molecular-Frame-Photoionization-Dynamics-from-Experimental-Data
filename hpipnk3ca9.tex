...
\item There are multiple bands of fits which converged to higher $\chi^2$; since there is a large step to the first of thesethese are most likely indicative of multiple local minima.
