...
\item The parameters with split/pairs of values are indicative of cases where these is an insensitivity in the fit. In this case, the [PU,3,1] case shows an insensitivity to the sign of the phase, which appears as a splitting due to the $mod(\pi)$ nature of the result, although there is a bias in the results towards one of the pai. (This type of effect will be discussed further below.)
\end{enumerate}
