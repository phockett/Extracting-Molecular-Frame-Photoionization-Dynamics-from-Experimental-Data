...
\begin{enumerate}
\item The results for the magnitudes show very little difference within each $chi^2$ range, and closer inspection reveals that values between typically within 5\%, with the exception of 
