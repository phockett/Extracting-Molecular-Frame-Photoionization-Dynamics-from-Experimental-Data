...
\item There are additional close-lying bands with $\chi^2 < 2.3\times10^{-3}$. In the test case, 349 fits obtained this region of the fitting space. These results may be due to 
