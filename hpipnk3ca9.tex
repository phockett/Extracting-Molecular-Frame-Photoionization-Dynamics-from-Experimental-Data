...
To investigate the fidelity of the results in this ideal case the best parameter set(s) can be compared with the input matrix elements, results are presented in Table [XX]. In this 
