...
\item Convergence criteria were set as a minimum gradient reduction of , but also capped by the total number of function evaluations to prevent run-away cases.
