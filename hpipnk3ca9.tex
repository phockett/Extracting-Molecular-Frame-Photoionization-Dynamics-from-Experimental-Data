...
\item Convergence criteria were set as both as a minimum gradient reduc, but also capped by the total number of function evaluations to prevent run-away cases.
\item Results are categorized by reduced $\chi^2$ values unless otherwise noted.
\end{itemize}
