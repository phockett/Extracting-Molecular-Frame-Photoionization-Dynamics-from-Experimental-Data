...
\item There are multiple bands of fits which converged to higher $\bar{\chi^2}$; since there is a large step to the first of these ($\chi^2 = 2.312\times10^{-3}$), and they appear with much lower frequency, these are most likely indicative of local minima.
