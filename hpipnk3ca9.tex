...
\item Convergence criteria were set as a minimum gradient reduction of $1e-2$ [TODO: ], but also capped by the total number of function evaluations to prevent run-away cases.
