...
\item Results as presented are categorized by reduced $\chi^2$ values ($=\chi^2/(N-N_{vars}$, where $N$ is the number of data points, and $N_{vars}$ the number of parameters) unless otherwise noted.
\end{itemize}
