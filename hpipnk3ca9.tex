...
\begin{enumerate}
\item The results for the magnitudes show very little difference for over the range investigated, indicating good agreement here in all results. Closer inspection reveals values typically within 5\%, with the exeption of the [PU,3,1] case which shows a larger spread.
\end{enumerate}
