...
The techniques are closely related, but differ in the "directness" of the reconstruction: in the former case, the aim is full matrix element retrieval, whilst in the latter the MFPADs are determined via a transfomation matrix, and full matrix element retrieval is not necessary.