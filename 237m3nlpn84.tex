...
\item The parameters indicate enhanced sensitivity to higher-order terms ($L=6$) just after the main revival feature. This was already apparent in Fig. \ref{652406}, and is correlated with the larger $K=4,6$ terms in the this region (see Fig. \ref{720080})
