...
More interesting in the density matrix representation is the visualisation of the phase relations between the matrix elements (off-diagonal elements), and the indication in the pattern of the elements that no phase-relations 
