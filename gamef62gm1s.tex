...
More interesting in the density matrix representation is the visualisation of the phase relations between the matrix elements (off-diagonal elements), and the ab indication in the pattern of the elements that no phase-relations are missing
