...
Where $\zeta,\zeta'$ collect all the required quantum numbers, and define all (coherent) components. The terms $\mathbb{I}_{lm\mu,l'm'\mu'}^{\Gamma,\Gamma'}$ denote the coherent square of the ionization matrix elements:
