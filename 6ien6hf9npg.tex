...
the given measurement),measurement), with dimensions dependent on the unique set of quantum numbers required for a given case (in the . The $L,M$ notation indicates here that these
