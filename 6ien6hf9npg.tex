...
This form arises naturally sincethe $\beta_{L,M}^{u}$ terms to the state multipoles (geometric tensors), which can be thought of as a coupled basis equivalent of the density matrix representations (see, e.g., ref. \cite{BlumDensityMat}, Chpt. 4.).
