...
In the case where a single measurement contains multiple $\beta_{L,M}$, e.g. as a function of energy $k$ or time , the information content will naturally be larger:
...
space spanned by the full set of $\{\beta_{L,M}^{u}(k,t)\}$. However,
