...
In this case, each $(\epsilon,t)$ is treated as an independent measurement with unique information content, although there may be redundancy as a function of $t$ depending on the nature of the rotational wavepacket - this is explored further in Sect. . (Note this is in distinction to cases where the time-dependence arose from a shaped laser-field, and was coherently integrated over in the measurements, which provided a coherently-multiplexed case, see refs. XX for details.)
