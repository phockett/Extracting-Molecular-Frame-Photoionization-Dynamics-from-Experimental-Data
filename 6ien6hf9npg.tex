...
the given measurement),measurement), with dimensions dependent on the unique sets of quantum numbers required (in the simplest case, this will just be a set of . The $L,M$ notation indicates here that these
