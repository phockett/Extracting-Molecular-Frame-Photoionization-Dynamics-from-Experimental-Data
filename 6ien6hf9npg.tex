...
for polarizations \(\mu\) and channels (symmetries) labelled by initial and final state indexes \({p_{i}\mu_{i},p_{f}\mu_{f}}\). The matrix elements are essentially identical to the simplified forms defined in Eqn. \ref{eq:r-kllam}, except using the notation 
