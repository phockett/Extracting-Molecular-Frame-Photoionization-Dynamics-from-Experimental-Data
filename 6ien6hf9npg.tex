...
the given measurement),measurement), with dimensions dependent on the unique set of quantum numbers required for a given case (in the simplest case, this will be just pa $(l,m)$). The $L,M$ notation indicates here that these
