...
defined by a set of partial-waves \(\{l,m\}\), for polarization comp \(\mu\) and channels (symmetries) labelled by initial and final state indexes \({p_{i}\mu_{i},p_{f}\mu_{f}}\). 
