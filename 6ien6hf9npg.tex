...
This form indicates the equivalence of the $\beta_{L,M}^{u}$ terms to the state multipoles, which can be thought of as a coupled basis equivalent of the density matrix representations.
