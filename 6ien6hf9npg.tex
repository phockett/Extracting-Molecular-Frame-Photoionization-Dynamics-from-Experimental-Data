...
In both cases a set of geometric tensor terms are required, which are fully defined in Appendix \ref{appendix:formalism}. Note that, in this case, time-dependence arises purely from the
