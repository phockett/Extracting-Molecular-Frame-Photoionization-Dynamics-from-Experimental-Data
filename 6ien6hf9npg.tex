...
A simple form of the equations amenable to fitting is to provide the observables in terms of ``channel functions", which define the ionization continuum for a given set of parameters $u$ (e.g. defined by an experimental configuration),
