...
Where $\Gamma,\Gamma'$ collect all the required quantum numbers, and define all (coherent) components. The terms $\mathbb{I}_{lm\mu,l'm'\mu'}^{\Gamma,\Gamma'}$ denote the coherent square of the ionization matrix elements:

\begin{equation}
\mathbb{I}_{lm\mu,l'm'\mu'}^{\Gamma,\Gamma'}=I_{l,m,\mu}^{\Gamma}(E)I_{l',m',\mu'}^{\Gamma'*}(E)
\end{equation}

This is effectively a convolution equation (cf. ref. ) with channel functions, for
