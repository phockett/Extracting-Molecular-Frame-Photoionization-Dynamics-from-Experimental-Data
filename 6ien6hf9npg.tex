...
In this case, each $(\epsilon,t)$ is treated as an independent measurement with unique information content, although there may be redundency as a function of $t$ depending on the nature of the rotational wavepacket.
