...
the given measurement),measurement), with dimensions dependent on the unique sets of quantum numbers required (in the simples. The $L,M$ notation indicates here that these
