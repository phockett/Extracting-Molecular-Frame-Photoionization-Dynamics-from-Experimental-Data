...
the given measurement),measurement), with dimensions dependent on the quantum numbers tial wave. with dimensions . The $L,M$ notation indicates here that these
