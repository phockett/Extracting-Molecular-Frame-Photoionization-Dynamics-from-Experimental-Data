...
Where $\zeta,\zeta'$ collect all the required quantum numbers, and define all (coherent) pairs of components. The terms \mathbb{I}^{\zeta\zeta'} denotes the coherent square of the ionization matrix elements:
