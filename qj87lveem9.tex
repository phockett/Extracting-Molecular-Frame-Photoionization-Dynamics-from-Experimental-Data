...
Beyond the basic case, increasingly sophisticated experimental schemes are becoming routine, examples include time-resolved PADs (in pump-probe experimental schemes \cite{Seideman2002} [plus Wu, others?])
