...
Photoionization describes the coupling of a systemIn essence, photoionization involves two key components: (1) the structure of the continuum (free electron) wavefunction 