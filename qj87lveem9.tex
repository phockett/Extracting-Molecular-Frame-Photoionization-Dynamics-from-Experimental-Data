...
The core physics of photoionization has been covered extensively in the literature, and only a very brief overview is provided here with sufficient detail to define the MF reconstruc; the reader is referred to the literature listed at the end of this section for further details.
