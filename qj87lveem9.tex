...
Photoionization describes the coupling of an initial state of the system to a final state, comprised of the (system  In essence, photoionization involves two key components: (1) the structure of the continuum (free electron) wavefunction 