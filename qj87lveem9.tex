...
Although the core physics is complicated, relatively high-dimensionality observables are possible for photoelectron measurements, hence experimental progress can be made to understand these light-matter interactions. The \textit{photoelectron angular distribution} (PAD) is the key observable, which is ideally also energy and
