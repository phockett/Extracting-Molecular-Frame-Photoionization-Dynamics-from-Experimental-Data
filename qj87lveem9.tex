...
Beyond the basic case, increasingly sophisticated experimental schemes are becoming routine, examples include state-selected measurements, time-resolved PADs (in pump-probe experimental schemes \cite{Seideman2002} [plus Wu, others?]), control schemes with shaped laser pulse(s), 
