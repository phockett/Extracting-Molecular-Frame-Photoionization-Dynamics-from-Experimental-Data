...
Where $\mathbf{\Gamma}$ are the reduced channel functions, explicitlindexed by all required quantum numbers for the LF and MF definitions. Again, full details can be found in Appendix \ref{app:mat-inversion}. Given these, the transformation matrix can be written as:
