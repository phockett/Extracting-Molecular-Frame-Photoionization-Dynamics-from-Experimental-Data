...
Where $\mathbf{\Gamma}$ are the reduced channel functions, in Again, full details can be found in Appendix \ref{app:mat-inversion}. Given these, the transformation matrix can be written as:
