...
Of particular import here is the phase-sensitive nature of the observables, which is required in order to obtain hence PADs can also be considered as angular interferograms. (Cf. FROG, tomography)
