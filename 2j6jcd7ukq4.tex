...
Where $\mathbf{\Gamma}$ are the reduced channel functions, explicitly indexed by all required quantum numbers for the LF and MF definitions ($\zeta. Again, full details can be found in Appendix \ref{app:mat-inversion}. Given these, the transformation matrix can be written as:
