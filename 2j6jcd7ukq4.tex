...
Where $\mathbf{C}$ are similar to the channel functions defined above, but \textit{without} the inclusion of alignment or frame rotation effects, and will be term. The relevant parameters can be explicitly defined as:
