...
\caption{\label{tab:matE}Input matrix elements for the simulated data, from ePolyScat calculations for $N_2$ at 1~eV, (comp)lex values, and in (m)agnitudes and (p)hase form. Note that the continuum symmetry is split into PU}
\end{table}