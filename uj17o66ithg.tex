...
\item To simulate the observables, photoionization matrix elements from ePolyScat calculations are used. This, naturally, also provides a means for direct comparison and fidelity analysis of
\end{enumerate}