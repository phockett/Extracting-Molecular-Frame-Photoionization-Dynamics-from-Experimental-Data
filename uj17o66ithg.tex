...
\item To investigate limitations of the numerical routines, noise and other artefacts can be added to the simulated data; different sub-sets of the data can also be readily analysed and
\end{enumerate}