...
Results are summarised in Figs. XX. Two important conclusions can be obtained from this case study:

\begin{enumerate}
\item Not all fits that converged - as defined by the criteria above - provided the 
\end{enumerate}
