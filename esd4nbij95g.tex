...
\item Code for AF computation and matrix element retrieval, as illustrated in Sect. XX. Full Jupyter notebooks are online (), along with the open-source python libraries \href{https://epsproc.readthedocs.io}{ePSproc} () and \href{https://pemtk.readthedocs.io}{PEMtk} ()/pmTK/pemTK/qmPEtk developed for these problems. [links to Github repos, also add to .bib]
