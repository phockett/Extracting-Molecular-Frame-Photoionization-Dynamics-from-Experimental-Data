...
\item Code for AF computation and matrix element retrieval, as illustrated in Sect. XX. Full Jupyter notebooks are online (), along the open-source python libraries ePSproc () and peQMtk ()/pmTK/pemTK/qmPEtk. [links to Github repos]
