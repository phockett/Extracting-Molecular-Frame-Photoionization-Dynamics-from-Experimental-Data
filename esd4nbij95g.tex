...
\item Code for AF computation and matrix element retrieval, as illustrated in Sect. XX. Full Jupyter notebooks are online (), along with the open-source python libraries ePSproc () and peQMtk ()/pmTK/pemTK/qmPEtk developed for th. [links to Github repos]
