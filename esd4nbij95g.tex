...
\item Code for AF computation and matrix element retrieval, as illustrated in Sect. XX. Full Jupyter notebooks are online (), and the openpython libraries ePSproc () and 
\end{itemize}