...
\item Implementation of additional fitting routines, both from standard numerical methods (EG...), and also from related specalised domain problems, for instance 
\end{itemize}
