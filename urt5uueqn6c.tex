...
\item Implementation of additional fitting routines, both from standard numerical methods (EG...), and also from related specialised domain problems, for example FROG-type retrieval methods and homotophy approaches. 
\end{itemize}
