...
In the current case, it is clear that the bootstrapping methodology for obtaining full photoionization matrix elements from time-domain, AF datasets, works well. The current numerical routines are  However, a range of outstanding questions and routes of investigation remain, for instance:
